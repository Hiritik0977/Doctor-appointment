...
const DoctorCard = ({doctor}) => {
  ...
  <div className='mt-2 lg:mt-4 flex items-center justify-between'>
    <span className='bg-[#9BE5AA] text-greencolor py-1 px-2 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold  rounded'>{specialization}</span>
    ...
    <div className='flex items-center gap-[6px] '>
       ...
       <div className='mt-[18px] lg:mt-5 flex items justigy-between'>
        ...
        <Link 
             to='/doctors' 
             className='w-[44px] h-[44px] rounded-full border border-solid border[#181A1E] mt-[15px] 
