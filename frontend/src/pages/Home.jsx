...
import faqImg from "../assets/images/c-man.jpg";
        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              ...
              >
                <p className="p-[8px] w-[30%] rounded-[15px] bg-textColor text-whiteColor ">
                  Close to you ⚕️
                </p>

                <h1 className="text-[36px] leading-[46px] text-headingColor font-[800] md:text-[50px] md:leading-[70px]">
                  Let us heal your lives.{" "}
                </h1>
                <h2 className="font-[500] text-[20px] text-headingColor">
                  Here care comes first!!!
                </h2>
                <p className="text__para text-greencolor">
                  Our platform offers seamless appointment scheduling with a
                  vast array of specialized doctors, catering to diverse medical
                  needs. From general practitioners to specialists, our site
                  ensures efficient healthcare access. Patients can easily
                  browse profiles, book appointments, and receive quality care,
                  empowering them to take control of their health journey..
                </p>

                <button className="btn bg-greencolor text-white text-[16px] leading-5 font-[500] hover:bg-whiteColor hover:text-black transition-all duration-300">
                  Consult Now
                </button>
              </div>
 ...
 */}
      ...
      <section>
        <div className="container">
          <div className="lg:w-[470px] mx-auto">
            ...
            <p className="text_para text-center p-[10px]">
              Trust in us we will never let you down. Our health expertise will
              give u best medical experience.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                <h2 className="text-[26px] leading-9 text-greencolor font-[700] text-center ">
                  Find a doctor
                </h2>
                <p className="text-[16px] leading-7 text-textColor font[400] mt-4 text-center">
                  Navigate our user-friendly interface to easily find the
                  perfect doctor. Filter by specialty, location, and
                  availability for personalized care.
                </p>
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font[400] mt-4 text-center">
                  Discover nearby healthcare facilities like Civil Hospital near
                  Shantinagar or renowned institutions like AIIMS Hospital in
                  India for convenient access.
                </p>
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font[400] mt-4 text-center">
                  Effortlessly book appointments with your preferred doctor on
                  your chosen date using our user-friendly system for
        ...
        <Marquee speed={80} gradient pauseOnHover>
          ...
          >
            <Link to="/fever">
              <img
                src={ent}
                className="w-[100px] h-[120px] rounded cursor-pointer"
              />
      ...
      <div
        ...
        className="flex p-[60px] "
      >
        <div className="container bg-creamcolor  ml-[20px] p-4 rounded-md mr-4 mt-10 ">
          <label
            className="text-[26px] leading-6 text-headingColor font-[700] text-center"
            htmlFor=""
          >
            We are known For:
          </label>
          <h1 className="font-[500] text-headingColor">
            Trust in us we will never let you down. Our health expertise will
            give u best medical experience.
          </h1>
        </div>
        ...
        <div className="container bg-creamcolor  ml-[20px] p-4 rounded-md mr-4 mt-10 ">
          ...
          <h1 className="font-[500] text-blackColor">
            Trust in us we will never let you down. Our health expertise will
            give u best medical experience.
          </h1>
        </div>
        ...
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            >
              ...
              <ul className="pl-4">
                ...
                <li className="text_para p-[10px]">
                  ...
                  online scheduling tool to select an appoitment time.
                </li>
              </ul>
              <Link to="/">
                <button className="btn bg-greencolor hover:bg-lightgreencolor  transition-all duration-300">
                  Learn More
                </button>
              </Link>
            </div>
            ...
            <div
              data-aos="fade-up"
              data-aos-duration="300"
              className="relative z-10 xl:w-[470px] flex justify-end mt-[50px] lg:mt-0"
            >
              ...
              <div className="w-[150px] h-[145px] lg:w-[200px] bg-white absolute bottom-[100px] left-0 md:bottom-[30px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                ...
                <div className="w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px] lg:px-[10px] text-[8px] leading-[8px] lg:text-[12px] lg:leading-4 textirisBlueColor font-[500] mt-2 lg:mt-4 rounded-full">
                  Consulation
                </div>

                <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]">
                  <img src={avatarIcon} alt="" />
                  <h4 className="text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] font-[600] text-headingColor">
                    Roshan Gupta
                  </h4>
                </div>
              </div>
        ...
        <div className="container">
          <div className="flex justify-between gap-[50px] lg:gap-0">
            <div className="w-1/3 hidden md:block  ">
              <img src={faqImg} alt="" className="rounded-[15px]" />
            </div>
