...
const Doctordash = () => {
  ...
  const reviews = [
    {
      name: "Ram",
      rating: 5,
      comment: "The staff and severices were too good",
    },
    {
      name: "Shyam",
      rating: 4,
      comment: "The doctor consulation was satisfying",
    },
  ...
  return (
    <div className="container">
      <p className="lead d-none d-sm-block text-[48px] mt-10 mb-10">
        All Appointment Details and Records
      </p>
      <div
      ...
      <div className="row">
        <div className="col-lg-7 col-md-6 col-sm-12">
          <h5 className="mt-3 mb-3 text-secondary">
            Check More Records of Appointments
          </h5>
